...
|------------|-------------|-------|--------------|
| [simonw/llm-gemini](https://github.com/simonw/llm-gemini) | LLM plugin to access Google's Gemini family of models | 380 | 2025-08-28 |
| [simonw/llm](https://github.com/simonw/llm) | Access large language models from the command-line | 9532 | 2025-08-28 |
| [simonw/llm-gpt4all](https://github.com/simonw/llm-gpt4all) | Plugin for LLM adding support for the GPT4All collection of models | 255 | 2025-08-28 |
...
| [taketwo/llm-ollama](https://github.com/taketwo/llm-ollama) | LLM plugin providing access to models running on an Ollama server | 335 | 2025-08-28 |
| [simonw/llm-mlx](https://github.com/simonw/llm-mlx) | Support for MLX models in LLM | 209 | 2025-08-28 |
| [simonw/llm-gguf](https://github.com/simonw/llm-gguf) | Run models distributed as GGUF files using LLM | 76 | 2025-08-28 |
| [mozanunal/llm-tools-kiwix](https://github.com/mozanunal/llm-tools-kiwix) | Turn any Kiwix ZIM archive (offline Wikipedia, Stack Exchange, DevDocs, etc.) into an instant knowledge source for LLMs with a tiny CLI + Python server exposing searchable chunks, metadata and citations. | 50 | 2025-08-28 |
| [simonw/llm-jq](https://github.com/simonw/llm-jq) | Write and execute jq programs with the help of LLM | 177 | 2025-08-28 |
| [luebken/llm-plugin-directory](https://github.com/luebken/llm-plugin-directory) | Unofficial llm plugin directory | 8 | 2025-08-28 |
