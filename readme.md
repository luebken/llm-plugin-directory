...
|------------|-------------|-------|--------------|
| [simonw/llm](https://github.com/simonw/llm) | Access large language models from the command-line | 10623 | 2025-12-23 |
...
| [taketwo/llm-ollama](https://github.com/taketwo/llm-ollama) | LLM plugin providing access to models running on an Ollama server | 345 | 2025-12-23 |
...
| [luebken/llm-plugin-directory](https://github.com/luebken/llm-plugin-directory) | Unofficial llm plugin directory | 12 | 2025-12-23 |
...
| [mozanunal/llm-tools-kiwix](https://github.com/mozanunal/llm-tools-kiwix) | Turn any Kiwix ZIM archive (offline Wikipedia, Stack Exchange, DevDocs, etc.) into an instant knowledge source for LLMs with a tiny CLI + Python server exposing searchable chunks, metadata and citations. | 63 | 2025-12-21 |
