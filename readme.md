...
|------------|-------------|-------|--------------|
| [simonw/llm](https://github.com/simonw/llm) | Access large language models from the command-line | 9597 | 2025-09-05 |
| [simonw/llm-openrouter](https://github.com/simonw/llm-openrouter) | LLM plugin for models hosted by OpenRouter | 221 | 2025-09-05 |
| [irthomasthomas/llm-consortium](https://github.com/irthomasthomas/llm-consortium) | Parallel Reasoning: llm-consortium orchestrates mulitple LLMs, iteratively refines & achieves consensus. | 364 | 2025-09-05 |
| [luebken/llm-plugin-directory](https://github.com/luebken/llm-plugin-directory) | Unofficial llm plugin directory | 9 | 2025-09-05 |
| [simonw/llm-jq](https://github.com/simonw/llm-jq) | Write and execute jq programs with the help of LLM | 179 | 2025-09-04 |
| [simonw/llm-sentence-transformers](https://github.com/simonw/llm-sentence-transformers) | LLM plugin for embeddings using sentence-transformers | 71 | 2025-09-04 |
| [mozanunal/llm-tools-kiwix](https://github.com/mozanunal/llm-tools-kiwix) | Turn any Kiwix ZIM archive (offline Wikipedia, Stack Exchange, DevDocs, etc.) into an instant knowledge source for LLMs with a tiny CLI + Python server exposing searchable chunks, metadata and citations. | 53 | 2025-09-04 |
| [FiloSottile/mostly-harmless](https://github.com/FiloSottile/mostly-harmless) | A bag of various unrelated projects with varying levels of serviceability and destructiveness. | 295 | 2025-09-04 |
